<?php if ($step1['plan_type'] == 'Elec' || $step1['plan_type'] == 'Dual'):?>
    ...
    <?php else:?>
        ...
        $umo = $plan['Plan']['elec_rate']['demand_uom'] ? $plan['Plan']['elec_rate']['demand_uom'] : 'kWh';
        ...
        <?php endif;?>
        <?php if ($plan['Plan']['elec_rate']['demand_uom'] && $plan['Plan']['elec_rate']['capacity_charge'] > 0):?>
            <strong>Capacity Charge</strong>
            <table class="table table-striped">
                <tr>
                    <td>Charge per <?php echo $umo;?>/<?php echo $period;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['capacity_charge'] * 100 * $gst, 3);?>c</td>
                    <td>per <?php echo $umo;?></td>
                </tr>
            </table>
        <?php endif;?>
        <?php if ($plan['Plan']['elec_rate']['demand_uom'] && $plan['Plan']['elec_rate']['summer_capacity_charge'] > 0):?>
            <strong>Summer Capacity Charge</strong>
            <table class="table table-striped">
                <tr>
                    <td>Charge per <?php echo $umo;?>/<?php echo $period;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['summer_capacity_charge'] * 100 * $gst, 3);?>c</td>
                    <td>per <?php echo $umo;?></td>
                </tr>
            </table>
        <?php endif;?>
        <?php if ($plan['Plan']['elec_rate']['demand_uom'] && $plan['Plan']['elec_rate']['non_summer_capacity_charge'] > 0):?>
            <strong>Non Summer Capacity Charge</strong>
            <table class="table table-striped">
                <tr>
                    <td>Charge per <?php echo $umo;?>/<?php echo $period;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['non_summer_capacity_charge'] * 100 * $gst, 3);?>c</td>
                    <td>per <?php echo $umo;?></td>
                </tr>
            </table>
        <?php endif;?>
        <?php if ($plan['Plan']['elec_rate']['demand_uom'] && $plan['Plan']['elec_rate']['high_demand_charge'] > 0):?>
            <strong>High Demand Charge</strong>
            <table class="table table-striped">
                <tr>
                    <td>Charge per <?php echo $umo;?>/<?php echo $period;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['high_demand_charge'] * 100 * $gst, 3);?>c</td>
                    <td>per <?php echo $umo;?></td>
                </tr>
            </table>
        <?php endif;?>
        <?php if ($plan['Plan']['elec_rate']['demand_uom'] && $plan['Plan']['elec_rate']['low_demand_charge'] > 0):?>
            <strong>Low Demand Charge</strong>
            <table class="table table-striped">
                <tr>
                    <td>Charge per <?php echo $umo;?>/<?php echo $period;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['low_demand_charge'] * 100 * $gst, 3);?>c</td>
                    <td>per <?php echo $umo;?></td>
                </tr>
            </table>
        <?php endif;?>
